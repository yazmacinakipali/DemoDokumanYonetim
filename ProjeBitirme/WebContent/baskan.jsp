...
<title>OKB DEGERLENDIRME SAYFASI</title>
...
String okbyetki = (String) sessionsa.getAttribute("okbyetki");
System.out.print(okbyetki);
%>
<%
if(okbyetki==null || okbyetki==""){
	response.sendRedirect("homepage.jsp");
}
%>
<form id="sonucladirmaform" action="Sonuclandirma" method="post">
<h1 align="center">OKB DEGERLENDIRME</h1>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<label>*Dokuman icin belirlenen hakemlerin degerlendirilmesi tamamlaninca sisteme dusecektir.</label>
<br></br>
<div align="center">
		...
		String strQuery = "SELECT * FROM dokumanlar where sonuc='hayir' ";
        ...
        try{
            ...
            String getId;
                while (rs.next())
                {
                  ...
                  double ort = (double)((Integer.parseInt(hakem1puan)+Integer.parseInt(hakem2puan)+Integer.parseInt(hakem3puan)))/3;
 				  %>
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;<td><%=hakem2puan%></td>
                  &nbsp;&nbsp;&nbsp;&nbsp;<td><%=hakem3puan%></td>
                  <td id="<%=taskId%>ort"><%=new DecimalFormat("##.##").format(ort)%></td>
                  <td id="<%=taskId%>kabulDurum">
                  <input type="radio" id="<%=taskId%>kabul" name="status" value="kabul">KABUL</input>
                  <input type="radio" id="<%=taskId%>red"   name="status" value="red">RED</input>
                  </td>
                  <td><input type="button" id="btnApprove" value="KARAR" onclick="getSelected(<%=taskId%>);"/>
                  </td>
                  </tr>
		...
		<div id="kabulsonuc" align="center">
		<h3 align="center">SONUÇLANDIRMA</h3>
		<label>Lutfen kontrol ediniz**</label><br />
    KABUL DURUMU:<input type="text" readonly="readonly" id="degerlendirme" name="degerlendirme" value=""></input><br /><br />
	DOKUMAN ID  :<input type="text" readonly="readonly" id="dokumanid" name="dokumanid" value=""></input><br /><br />
	OGRENCI ADI :<input type="text" readonly="readonly" id="ogrenciSonuc" name="ogrenciSonuc" value=""></input><br /><br />
		<input type="submit" value="SONUÇLANDIR" ></input><br />
		</div>
</form>
